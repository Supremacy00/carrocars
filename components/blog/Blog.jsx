              ...
              >
                ...
                <div className="mx-4 flex-grow xxl:mx-8">
                  ...
                  <div className="text-secondary font-semibold mb-2.5 xxl:mb-3.5">
                      <h1 className="text-[16px] line-clamp-1 xxl:text-[20px] xxl:leading-8 hover:text-blue-700 transition-colors duration-300 ease-in-out cursor-pointer">
                        {item.blogTitle}
                      </h1>
                  </div>
                  <div className="text-[13px] text-[#5F6973] leading-6 line-clamp-1 sm:line-clamp-3 lg:line-clamp-2">
                  ...
                  <section className="hidden md:flex mt-5">
                    <div className="flex items-center gap-3 group cursor-pointer xl:gap-4">
                      ...
                      <div className="relative bg-[#F5C34B] w-7 h-7 rounded-full group-hover:bg-secondary transition-colors duration-300 ease-in-out xxl:w-9 xxl:h-9">
