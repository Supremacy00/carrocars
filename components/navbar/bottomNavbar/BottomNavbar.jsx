...
const BottomNavbar = () => {
  ...
  return (
    <div>
      <nav className="mx-auto max-w-[1220px] relative flex justify-between items-center py-4 px-4 z-40 text-secondary md:px-6 lg:max-w-[991px] xl:py-7  xl:px-8 xxl:max-w-[1355px]">
        <Link href="/">
