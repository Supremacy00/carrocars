...
import { featureListingsData } from "@/components/featureListingsData";
...
const AllStatus = () => {
    ...
    const slicedFeatureListingData = featureListingsData.slice(0, 6);
  return (
            ...
            >
                ...
                <div className="absolute top-0 inset-0 text-white">
                  ...
                  >
                    <div className="flex items-center gap-0.5">
                      ...
                      <p className="text-[13px] cursor-text">{item.numberOfImages}</p>
                    </div>
              ...
              <div className="mx-6 flex-grow">
                <div className="text-secondary font-semibold mb-3">
                  ...
                  <Link href={`/listings/car-details/${item.FL_}`}><p className="text-[13px]">{item.flTitle}</p></Link>
                </div>
